...
void AnalogTimer::paintEvent (QPaintEvent*)
{
	...
	p.save ();
	{
		...
		double range_f = 1.0 - start;
		double range_l = (full_hours + 1.0)*2.0 + full_hours*(tr_l + full_l) + current_l;
		estimated_current_grad = QRadialGradient (estimated_circle_center, estimated_circle_radius*0.89);
		...
		estimated_current2_grad = QRadialGradient (estimated_circle_center, estimated_circle_radius*0.89);
		...
		estimated_current3_grad = QRadialGradient (estimated_circle_center, estimated_circle_radius*0.89);
		...
		estimated_full_grad = QRadialGradient (estimated_circle_center, estimated_circle_radius*0.89);
